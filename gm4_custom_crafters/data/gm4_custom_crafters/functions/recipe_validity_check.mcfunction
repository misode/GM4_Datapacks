# @s = gm4_custom_crafter unless data storage gm4_custom_crafters:temp/crafter {Items:[]}
#Run from main
...
execute store result score first_stack_count gm4_stack_size run data get storage gm4_custom_crafters:temp/crafter Items[0].Count
