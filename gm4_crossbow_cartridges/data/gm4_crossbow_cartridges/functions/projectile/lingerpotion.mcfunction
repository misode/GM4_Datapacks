...
execute unless entity @s[gamemode=creative] run item entity @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:lingering_potion"}]}] weapon.offhand replace minecraft:air
